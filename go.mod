...
// The realms target the crossing API gnodev serves; the published module still
// predates it, so this builds against a gno checkout rather than the proxy.
// Relative, and correct for a GOPATH-style tree — repoint it if yours differs.
